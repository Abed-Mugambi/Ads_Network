          ...
          <div className="carousel-inner">
            {ad.images.map((image, i) => (
              <div
                ...
                key={i}
              >
                <img src={image.url} className="d-block w-100" alt={ad.title} style={{ height: "500px"}} />
                                ...
                                <h6>{seller?.name}</h6>
                                  ...
                                  <div>
                                    ...
                                    onClick={() => setshowNumber(true) }>
                                      ...
                                      <br></br>
                                      {ad.postedBy  !== auth.currentUser?.uid &&  (
                                          <button className="btn btn-secondary btn-sm mb-3" onClick={createChatroom}>Chat With Seller</button>
                                      )} 
                                
                                  </div> : (
                                     <p className="text-center">
                                     <Link to="/auth/login" state={{from: location}}
                                     className="text-primary">Login</Link> to see contact info
                                      ...
                                      <div className="mt-5 text-center">
                                        {!ad.isSold && ad.postedBy === auth.currentUser?.uid && (
                                          <button className="btn btn-secondary btn-sm" onClick={updateStatus}>Mark as Sold </button>
                                        )}
